		...
		<table class="table table-hover table-compact table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td><span class="truncate" title="<?php echo htmlspecialchars($desc, ENT_QUOTES); ?>">
					...
					<td class="text-center">
						<div class="btn-group dropdown">
		                    ...
		                    <div class="dropdown-menu w-auto" role="menu" style="">
	                    	 <a class="dropdown-item action_load" href="./?page=lesson/view_lesson&id=<?php echo $row['id'] ?>">View</a>
