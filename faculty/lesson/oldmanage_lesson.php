			...
			<form action="" id="manage-lesson">
				...
				<div class="form-group">
					...
					<select name="subject_id" id="subject_id" class="custom-select custom-select-sm select2" required="">
						...
						?>
							<option value="<?php echo $row['id'] ?>" <?php echo isset($subject_id) && $subject_id == $row['id'] ? 'selected' : '' ?>><?php echo $row['course'] ?></option>
						<?php endwhile; ?>
					</select>
				</div>
				<div class="form-group">
					...
					<select name="class_ids[]" id="class_id" class="custom-select custom-select-sm select2" required="" multiple="multiple">
						...
						?>
							<option value="<?php echo $row['level'] ?>" <?php echo isset($class_arr) && (in_array($row['level'],$class_arr)) ? 'selected' : '' ?>><?php echo $row['level'] ?></option>
						<?php endwhile; ?>
					</select>
				</div>
				<div class="form-group">
