	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<select name="department" id="department_id" class="custom-select custom-select-sm select2" required="">
					<option value=""></option>
					<?php 
			...
			<div id="error-message" style="color: red; display: none;">Invalid Student ID</div>
			<div class="form-group">
...
<script>
    document.getElementById('student_id').addEventListener('input', function() {
        ...
        const validPrefixes = ['CS', 'AI', 'SW', 'NC', 'CY'];
        const prefix = studentId.substring(0, 2).toUpperCase(); // Get first two letters and convert to uppercase
